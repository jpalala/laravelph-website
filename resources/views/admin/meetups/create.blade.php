...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.meetup.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.meetups.store") }}" enctype="multipart/form-data">
            @csrf
...
name="registration_url" id="registration_url" value="{{ old('registration_url', '') }}" required>
...
id="timezone" value="{{ old('timezone', '') }}">
...
id="is_bootcamp" value="{{ old('is_bootcamp', '0') }}" step="1">
...
id="reg_is_open" value="{{ old('reg_is_open', '1') }}" step="1" required>
...
name="covid_status_form" id="covid_status_form" value="{{ old('covid_status_form', '') }}">
